...
# Ajoute le dossier contenant le fichier video_depth_stream.py
sys.path.append(os.path.join(os.path.dirname(__file__), "Video_Depth_Anything", "video_depth_anything"))

# Ajoute le dossier racine pour accéder aux modules utils/
...
from Video_Depth_Anything.utils.dc_utils import apply_depth_colormap
